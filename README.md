...
| 1     | Single-Item Measure of Stress Symptoms (SIMS; Elo et al., 2003)                                               | • Stress                                                                                                                                                                                     |
| 1     | Single-Item Self-Esteem Scale (SISE; Robins et al., 2001)                                                     | • Self-esteem                                                                                                                                                                                |
| 1     | Self-Concept Clarity Scale, item 11 (SCCS; Campbell et al., 1996)                                             | • Self-concept clarity                                                                                                                                                                       |
...
| 2–6   | Demographics (custom items)                                                                                  | • Education<br>• Discipline<br>• Student status<br>• Ethnicity<br>• Country                                                                                                                  |
| 2–6   | Multidimensional Interoceptive Traits questionnaire (MINT; Makowski et al.)                                  | WIP                                                                                                                                                                                          |
| 2–6   | Beliefs about Artificial Intelligence Technology (BAIT; Makowski et al.)                                     | WIP                                                                                                                                                                                          |
| 2–6   | Subjective financial well-being (ESS / OECD item)                                                             | • Household financial comfort                                                                                                                                                                |
| 2–6   | MacArthur Scale of Subjective Social Status (Adler et al., 2000)                                              | • Subjective social status                                                                                                                                                                   |
| 2–6   | Patient Health Questionnaire-4, refined 5-option version (PHQ-4; Kroenke et al., 2009; Makowski et al., 2025) | • Anxiety<br>• Depression                                                                                                                                                                    |
| 2–6   | Single-Item Sleep Quality Scale (SQS; Snyder et al., 2018)                                                    | • Sleep quality                                                                                                                                                                              |
| 2–6   | Psychiatric history (custom items)                                                                            | • Current diagnoses<br>• Current treatments                                                                                                                                                  |
| 2–6   | HiTOP Brief Report (HiTOP-BR; Simms et al., 2026)                                                             | • Somatoform<br>• Internalizing<br>• Thought Disorder<br>• Detachment<br>• Disinhibition<br>• Antagonism                                                                                     |
| 2–6   | HEX-ACO-18 (Olaru & Jankowsky, 2022)                                                                          | • Honesty-Humility<br>• Emotionality<br>• Sociability (eXtraversion)<br>• Patience (Agreeableness)<br>• Diligence (Conscientiousness)<br>• Curiosity (Openness)                              |
| 2–6   | Social Desirability-Gamma Short Scale (KSE-G; Kemper et al., 2014)                                            | • Exaggerating positive qualities<br>• Minimising negative qualities                                                                                                                         |
| 2–6   | Open Source Archetype Indicator – Pearson-Marr (OSAI-PM; not validated)                                       | • Idealist<br>• Sage<br>• Seeker<br>• Revolutionary<br>• Magician<br>• Warrior<br>• Realist<br>• Jester<br>• Lover<br>• Creator<br>• Ruler<br>• Caregiver                                    |
| 7     | Primals Inventory-18 (PI-18; Clifton & Yaden, 2021) + five tertiary scales (PI-99; Clifton et al., 2019)      | • Safe<br>• Enticing<br>• Alive<br>• Acceptable, Changing, Hierarchical, Interconnected, Understandable                                                                                      |
| 8     | ICAR-16 Sample Test (ICAR16; Condon & Revelle, 2014; Young & Keith, 2020)                                     | • Verbal (Verbal Reasoning)<br>• Logical (Letter Series)<br>• Visual (Matrix Reasoning)<br>• Spatial (Three-Dimensional Rotation)                                                            |
| 9     | Adult ADHD Self-Report Scale v1.1, items 1-2 (ASRS; Kessler et al., 2005)                                     | • Inattention                                                                                                                                                                                |
| 9     | Cognitive Failures Questionnaire, items 10 and 21 (CFQ; Broadbent et al., 1982)                               | • Absent-mindedness                                                                                                                                                                          |
| 9     | Mind Wandering: Spontaneous, items 1 and 4 (MW-S; Carriere et al., 2013)                                      | • Mind wandering                                                                                                                                                                             |
| 9     | Brief Self-Control Scale, items 1-2 (BSCS; Tangney et al., 2004)                                              | • Self-control                                                                                                                                                                               |
| 9     | Emotion Reactivity Scale, six items (ERS; Nock et al., 2008)                                                  | • Emotional sensitivity<br>• Emotional arousal<br>• Emotional persistence                                                                                                                    |
| 9     | Cognitive Emotion Regulation Questionnaire, short form (CERQ-short; Garnefski & Kraaij, 2006)                 | • Self-blame<br>• Acceptance<br>• Rumination<br>• Positive refocusing<br>• Refocus on planning<br>• Positive reappraisal<br>• Putting into perspective<br>• Catastrophising<br>• Other-blame |
| 10    | Closing items (custom items)                                                                                  | • Seriousness of participation<br>• Free comments                                                                                                                                            |

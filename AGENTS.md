...
- **An item key's middle segment is not always the scored dimension, and
  ...
  **The opinions level is the one place the *first* segment is not the
  ...
  (`Opinion_LibAuth_Sentences`, `Opinion_Conspiracy_1`), not the instrument
